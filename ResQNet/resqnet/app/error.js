...
/**
 * Global error boundary — rendered by Next.js when a page segment throws
 * an unhandled runtime error. Must be a Client Component.
 *
 * Props:
 *  - error  : the thrown Error object
 *  - reset  : function that re-renders the segment (retry)
 */
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
      ...
      <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-light mb-6">
        <AlertOctagon className="h-8 w-8 text-primary" aria-hidden="true" />
      </span>
